...
import com.kiran.model.JobSeekerData;
...
public class JobSeekerOperationsController {
	...
	public   String  register(@ModelAttribute("js") JobSeekerData jsData,
			                Map<String,Object> map)throws Exception {
		//get Upload folder location from properties file
			
		String storeLocation= "/var";// env.getRequiredProperty("upload.store");
		//String filename = "/var/tmp/mysql.png";
		System.out.println(storeLocation+"  location ffff");
